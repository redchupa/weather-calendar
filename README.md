...
> - 정확한 값은 [code.go.kr 법정동코드 검색](https://www.code.go.kr/stdcode/regCodeL.do) → 본인 시군구 입력 → **끝이 `000000` 으로 끝나는 시군구 단위 코드** 사용
> - 또는 아래 자주 쓰는 코드 표에서 골라 쓰기

<details>
<summary><b>📋 자주 쓰는 시군구 행정표준코드 (펼치기)</b></summary>
...
> 본인 지역이 위에 없으면 [code.go.kr 법정동코드 검색](https://www.code.go.kr/stdcode/regCodeL.do) 에서 검색하세요.
